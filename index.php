...
<?php
/*fitur update kamar aplicare ini adalah
  penyempurnaan dari kontribusi HaGa IT Solution
*/
session_start();
...
<title>Hospital MIS Dashboard</title>
<!-- Bootstrap Core CSS -->
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <!--Sidebar Menu Items -
        These collapse to the responsive navigation Menuon
        on small screens
    -->
